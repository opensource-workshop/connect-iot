...
namespace App\PluginsOption\Api\Receives;
...
use App\PluginsOption\Api\ApiPluginOptionBase;
 ...
 * @package Contoroller
 */
class Receives extends ApiPluginOptionBase
{
        ...
        */
        ...
        foreach ($values as $column => $value) {
            $receive_data = ReceiveData::create([
                ...
                'column_key' => $column,
                'value'      => $value,
                'num_value'  => is_numeric($value) ? floatval($value) : 0,
                'month'      => date('Y-m'),
                'date'       => date('Y-m-d'),
            ]);
        }
